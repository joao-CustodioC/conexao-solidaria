        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden w-full">
                <div className="flex justify-between items-center bg-blue-500 text-white p-6">
                    <h1 className="text-xl font-semibold">Escolha a instituição</h1>
                </div>
                <div className="overflow-x-auto p-6">
                    <table className="min-w-full bg-white">
                        ...
                        <tr>
                            ...
                            <th className="py-3 px-6 text-left">Valores doados</th>
                        ...
                        {data.map((e, i) => (
                            <tr key={i} className="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td className="py-3 px-6 text-left">{CalculaDoacoes(e.doacoes)}</td>
                                <td className="py-3 px-6 text-left">
                                    <div
                                        className="text-blue-500 cursor-pointer"
                                        onClick={() => handlePage(`/instituicoes/doacao/${e.id}`)}
                                    >
                                        <PiMoneyLight/>
                                    </div>
                                </td>
