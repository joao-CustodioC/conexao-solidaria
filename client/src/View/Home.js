...
const Home = () => {
    ...
    const availableQuickActions = quickActions.filter((action) => !action.adminOnly || activeUser.isAdmin)
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                <div
                    className="absolute top-0 left-1/4 w-96 h-96 bg-purple-500/30 rounded-full blur-3xl animate-pulse"></div>
                <div
            ...
            <div className="relative z-10">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex items-center space-x-3">
                                    <div className="relative">
                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl blur-md opacity-75"></div>
                                        <div
                                            className="relative p-2 bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        {user?.isAdmin && (
                                            <div
                                                className="p-1 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg">
                        ...
                        <div className="text-center mb-16">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                                <button
                                    ...
                                    <div
                                        className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                </button>
                            </div>
                        </div>
                            ...
                            {availableQuickActions.map((action, index) => (
                                ...
                                >
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <ArrowRight
                                            className="w-5 h-5 text-white/40 group-hover:text-white/80 group-hover:translate-x-1 transition-all ml-auto"/>
                                    </div>
                                </button>
                            ))}
                        </div>
                ...
                <section className="py-10 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl font-bold text-white mb-4">Por que escolher a Conexão
                                Solidária?</h2>
                ...
                {user?.isAdmin && (
                    <section className="py-16 px-4 sm:px-6 lg:px-8">
                        <div className="max-w-7xl mx-auto">
                            <div
                                className="bg-gradient-to-r from-yellow-500/10 via-orange-500/10 to-red-500/10 backdrop-blur-sm border border-yellow-400/20 rounded-3xl p-8">
                ...
                <footer className="py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        <div
                            ...
                            <p className="text-white/60 mb-4">Transformando o mundo através da tecnologia e
                                solidariedade</p>
