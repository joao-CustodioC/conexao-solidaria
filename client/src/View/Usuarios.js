                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-8">
                                ...
                                <span className="text-white/80 text-sm font-medium">{data.length} usuários registrados</span>
                            </div>
                ...
                <span className="block bg-gradient-to-r from-white via-emerald-200 to-teal-200 bg-clip-text text-transparent">
                  ...
                  SOLIDÁRIA
                            ...
                            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-12 leading-relaxed">
                                Conheça os <span className="text-emerald-300 font-semibold">heróis anônimos</span> que fazem a{" "}
                        ...
                        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
                                {data.map((usuario, i) => (
                                    ...
                                    >
                                        <div className="flex items-start space-x-4 mb-4">
                                            <div className="relative">
                                                <div className="p-3 bg-gradient-to-r from-emerald-100/20 to-teal-100/20 rounded-xl border border-white/10">
                              ...
                              Admin
                                                        ...
                                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-emerald-500/20 text-emerald-300 border border-emerald-400/30">
